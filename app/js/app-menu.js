...
(function() {
  ...
  function initDrawer() {
      ...
      <div class="bs-drawer-panel" onclick="event.stopPropagation()">
        ...
        <div class="bs-drawer-body">
          ...
          <div class="mq-menu">
            ...
            <a href="#" id="mqDemoAssistant"><i class="bs-ico" data-ico="spark"></i>Revoir la démo de l'assistant</a>
    ...
    // « Revoir la démo » : on ferme le tiroir d'abord, sinon la surcouche
    // éclairerait une zone cachée derrière lui (app-demo-assistant.js).
    var lienDemo = document.getElementById('mqDemoAssistant');
    if (lienDemo) {
      lienDemo.addEventListener('click', function (e) {
        e.preventDefault();
        if (typeof window.closeAppDrawer === 'function') window.closeAppDrawer();
        setTimeout(function () {
          if (window.bsDemoAssistant) window.bsDemoAssistant.rejouer();
        }, 320);
      });
    }
