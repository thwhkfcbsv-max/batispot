...
(function () {
  ...
  function monter(conteneur, opts) {
    ...
    conteneur.innerHTML = ''
      ...
      + '    <button type="button" data-bs="tout" style="background:none;border:none;color:#0F5132;cursor:pointer;font-size:12.5px;font-weight:800;">Tout cocher / décocher</button>'
      + '  </div>'
    ...
    function rendre() {
      ...
      lignes.forEach(function (l, i) {
        ...
        meta.style.cssText = 'font-size:12.5px;color:#5A7268;';
        meta.textContent = l.categorie;
        var badge = document.createElement('span');
        badge.style.cssText = 'font-size:12.5px;font-weight:800;color:' + (COULEUR_CONFIANCE[l.confiance] || '#92400E')
        ...
        if (existant) {
          ...
          remp.style.cssText = 'font-size:12.5px;color:#9A3412;display:block;margin-top:2px;';
        ...
        if (l.prix === null) {
          ...
          vide.style.cssText = 'font-size:12.5px;color:#9A3412;display:block;margin-top:2px;';
        ...
        unite.style.cssText = 'font-size:12.5px;color:#5A7268;';
