...
// ── Utilitaires date ───────────────────────────────────────
// Date LOCALE (12/09) : toISOString() seul datait la veille une date construite à minuit.
const AAAAMMJJ = (d) => new Date(d.getTime() - d.getTimezoneOffset() * 60000).toISOString().slice(0, 10);
